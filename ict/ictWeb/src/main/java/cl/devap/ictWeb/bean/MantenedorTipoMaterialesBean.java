 ...
 */
@ManagedBean (name="mantenedorTipoMaterialesBean")
@ViewScoped
@Component
@Scope("view")
public class MantenedorTipoMaterialesBean implements Serializable{
	...
	final static Logger logger = Logger.getLogger(MantenedorTipoMaterialesBean.class);
